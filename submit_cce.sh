#!/bin/bash
#SBATCH --job-name=train_4_256_CCE
#SBATCH --output=slurm/train_full_CCE_loss_CNN_BEND_1026_max_length_00006_lr_256_d_model_4_order_32_batch_size_100_epochs_%a_layers_%A.out
#SBATCH --error=slurm/train_full_CCE_loss_CNN_BEND_1026_max_length_00006_lr_256_d_model_4_order_32_batch_size_100_epochs_%a_layers_%A.err
#SBATCH --nodes=1
...
RUN_NAME="CCE_${ORDER}_order_${BATCH_SIZE}_batch_size_${EPOCHS}_epochs_${DATE}"
