#!/bin/bash
#SBATCH --job-name=tiny_128_freeze
#SBATCH --output=slurm/fine_tuning_CNN_BEND_tiny_128_d_model_freeze_00006_lr_32_batch_size_50_epochs_%j.out
#SBATCH --error=slurm/fine_tuning_CNN_BEND_tiny_128_d_model_freeze_00006_lr_32_batch_size_50_epochs_%j.err
#SBATCH --nodes=1
...
OUT_DIR="./outputs/fine_tuning/CCE_loss/${DECODER}_${PRETRAINED_MODEL}_${LR_name}_lr/${RUN_NAME}"
WANDB_RUN_NAME="$fine_tuning_CCE_loss_${DECODER}_${PRETRAINED_MODEL}_${FREEZE_name}_${BATCH_SIZE}_batch_size_${EPOCHS}_epochs_${LR_name}_lr"
